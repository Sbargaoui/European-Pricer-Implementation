...
Public Partial Class RadAboutBox1
    ...
    Public Sub New()
        ...
        '  - AssemblyInfo.cs
        Me.Text = String.Format("About {0}", "Interface de Pricing")
        Me.radLabelProductName.Text = "Interface de Pricing "
        Me.radLabelVersion.Text = String.Format("Version {0}", AssemblyVersion)
        Me.radLabelCopyright.Text = AssemblyCopyright
        Me.radLabelCompanyName.Text = "Sami Bargaoui / BIAT"
        Me.radTextBoxDescription.Text = "Interface de Pricing d'options avec choix de volatilité, instrument. Backtest et analyses et fiches de produits."
    End Sub
